...
namespace PBaszak\UltraMapper\Mapper\Domain\Modules\Matcher;
 ...
 */
class Matcher implements Contract\MatcherInterface
{
    /**
     * @param Contract\PropertyMatchingStrategy[]|class-string<Contract\PropertyMatchingStrategy>[] $propertyMatchingStrategies
     * @param Contract\ClassMatchingStrategy[]|class-string<Contract\ClassMatchingStrategy>[]       $classMatchingStrategies
     */
    public function __construct(
        ...
        array_walk(
            ...
            fn (string|Contract\PropertyMatchingStrategy $strategy): Contract\PropertyMatchingStrategy => is_string($strategy) ? new $strategy() : $strategy
        );

        array_walk(
            $this->classMatchingStrategies,
            fn (string|Contract\ClassMatchingStrategy $strategy): Contract\ClassMatchingStrategy => is_string($strategy) ? new $strategy() : $strategy
        );
    }
    ...
    public function matchClassBlueprintsBasedOnProperty(
        ...
        /** @var ClassBlueprint $originClass */
        foreach ($originClasses as $originClass) {
            /** @var ClassBlueprint $sourceClass */
            foreach ($sourceClasses as $sourceClass) {
                /** @var ClassBlueprint $targetClass */
